...
function fixlinks_showHide(img, hidetext, showtext){
...
function fixlinks_setExpanded(ids, expanded) {
...
fixlinks_setExpanded(['names', 'defaults', 'display'], false);
//]]>